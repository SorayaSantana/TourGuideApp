...
public class TourItemAdapter extends ArrayAdapter<TourItem>  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the tour item object located at this position in the list
        TourItem currentTourItem = getItem(position);

        // Find the TextViews in the list_item.xml layout and fill in with data
        TextView titleTextView = (TextView) listItemView.findViewById(R.id.title_text_view);
        titleTextView.setText(currentTourItem.getTitleId());

        TextView shortDataTextView = (TextView) listItemView.findViewById(R.id.datashort_text_view);
        shortDataTextView.setText(currentTourItem.getShortDataId());

        TextView longDataTextView = (TextView) listItemView.findViewById(R.id.datalong_text_view);
        longDataTextView.setText(currentTourItem.getLongDataId());

        // Find the ImageView in the list_item.xml layout and fill in in case image available
